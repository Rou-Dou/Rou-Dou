...
<ul>
  <li style="list-style: square;">🚧 Currently working on some simple python programming projects to solidfy new concepts, as well as working on sound design and impelmentation for a game in unreal engine.</li>
  <li style="list-style: square;">🌱 Currently learning OOP in C/C++ and refreshing myself on T-SQL.
